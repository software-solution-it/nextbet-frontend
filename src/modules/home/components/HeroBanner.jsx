...
const HeroBanner = ({ selectedCategory }) => {
  ...
  const mobileHeroImages = [
    "https://static.betfiery5.com/1716294916711879793_h5activity50.jpg",
    "https://static.betfiery5.com/1716294929449882479_h5activity15.jpg",
    "https://static.betfiery5.com/1716294940312358399_h5activity10.jpg",
    "https://static.betfiery5.com/1716294951553438926_h5activity6.jpg",
  ];

  // Carrossel de Destaques (exemplo com 10 imagens)
  const highlightImages = Array.from({ length: 10 }).map((_, i) => ({
    src: "https://static.betfiery5.com/1709287516716366641_15.png",
    alt: `Card ${i + 1}`,
  }));
      ...
      */}
      <div className="banner-desktop">
        <div className="relative mt-4">
          <img
            src="https://betfiery5.com/assets/images/hero-image-1.png"
